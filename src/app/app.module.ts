...
import { InternauteComponent } from './components/admin-components/internaute/internaute.component';
import { ListReclamationComponent } from './components/admin-components/list-reclamation/list-reclamation.component';
